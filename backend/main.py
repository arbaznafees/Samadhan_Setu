...
from app.routers import auth, citizen, hei, industry, govt, media, notifications, health, chat
...
# CORS Middleware with full local development & Vercel deployment support
app.add_middleware(
    CORSMiddleware,
