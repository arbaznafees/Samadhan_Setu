...
EMAIL_ALIASES = {
    "admin@samadhansetu.jh.gov.in": "admin@jharkhand.gov.in",
    "govt@samadhansetu.jh.gov.in": "admin@jharkhand.gov.in",
    "govt.admin@samadhansetu.jh.gov.in": "admin@jharkhand.gov.in",
    "csr@samadhansetu.jh.gov.in": "csr@tatasteel.com",
    "industry@samadhansetu.jh.gov.in": "csr@tatasteel.com",
    "industry.partner@samadhansetu.jh.gov.in": "csr@tatasteel.com",
    "hei@samadhansetu.jh.gov.in": "bit.mesra@samadhansetu.jh.gov.in",
}

@router.post("/login", response_model=TokenResponse)
def login(login_data: UserLogin, db: Session = Depends(get_db)):
    clean_email = login_data.email.strip().lower()
    resolved_email = EMAIL_ALIASES.get(clean_email, clean_email)
