...
interface AuthContextType {
  ...
  loginAs: (role: "citizen" | "hei_reviewer" | "industry_partner" | "govt_admin") => Promise<UserProfile | null>;
  logout: () => void;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const loginAs = async (role: "citizen" | "hei_reviewer" | "industry_partner" | "govt_admin"): Promise<UserProfile | null> => {
